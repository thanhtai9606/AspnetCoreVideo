...
namespace VideoCatalog
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           services.AddDbContext<VideoCatalogContext>(options =>
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory, VideoCatalogContext context)
        {
